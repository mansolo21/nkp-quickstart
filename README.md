...
1. Create a jump host with 2 vCPUs, 8 GB memory, use the Rocky image (update disk to 180 GiB), and the following Cloud-init custom script
...
## Create NKP Management cluster on Nutanix
